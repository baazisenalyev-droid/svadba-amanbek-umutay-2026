...
function updateCountdown() {
    ...
    const weddingDate = new Date('2026-08-26T16:00:00+06:00');
...
function initializeWebsite() {
    ...
    setTimeout(() => {
        console.log('%c[Wedding] 3D invitation ready — Аманбек & Умутай (26 августа 2026)', 'color:#C9A961');
    }, 1200);

    // Light scroll animations for sections
    const sections = document.querySelectorAll('#countdown, #details, #location, footer');
